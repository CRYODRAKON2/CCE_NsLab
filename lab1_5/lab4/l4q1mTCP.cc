...
main (int argc, char *argv[])
{
  ...
  NodeContainer c0 = NodeContainer (c.Get (0), c.Get (1));//point to point
...
ApplicationContainer sourceApps = source.Install (c0.Get (0));
sourceApps.Start (Seconds (0.0));
sourceApps.Stop (Seconds (10.0));


 // ApplicationContainer srcC = source.Install (c0.Get (0));
